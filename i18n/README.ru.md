...
| | **Yggdrasil** | [context-mode](https://github.com/mksglu/context-mode) | [Context7](https://github.com/upstash/context7) | простая «память» LLM |
| --- | --- | --- | --- | --- |
| Помнит **ваши** решения и уроки | ✅ долговечно | ⚠️ в рамках сессии | ❌ | ⚠️ одна сессия |
| Сохраняется **между сессиями и инструментами** | ✅ | ❌ *новая сессия = чистый лист* | ✅ | ❌ |
| Кросс-**проектный** recall | ✅ | ❌ | — | ❌ |
| Держит **живое контекстное окно** лёгким | — | ✅ | ❌ | ❌ |
| Свежая **документация публичных библиотек** | ❌ *(используйте Context7)* | ❌ | ✅ | ❌ |
| Пишет и **консолидирует** память (управляемо) | ✅ | ❌ | ❌ только чтение | ⚠️ |
| **Локально и приватно** | ✅ | ✅ | ☁️ хостинг | зависит |
